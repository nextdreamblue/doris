...
public class OlapTableTest {
    ...
    public void testResetPropertiesForRestore() {
        ...
        olapTable.resetPropertiesForRestore(false, false, replicaAlloc, false, false);
        ...
        olapTable.setTableProperty(tableProperty);
        olapTable.resetPropertiesForRestore(false, false, ReplicaAllocation.DEFAULT_ALLOCATION, false, false);
